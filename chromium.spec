...
Source1:        %{rname}-%{version}.tar.xz.aa
Source2:        %{rname}-%{version}.tar.xz.ab
Source3:        %{rname}-%{version}.tar.xz.ac

Source5:        esbuild.tar.gz
Source6:        README.SUSE
...
%prep
cat %{SOURCE1} %{SOURCE2} %{SOURCE3} >  %{SOURCE0}
